 ...
 */var g1;function Jw(){if(g1)return vo;g1=1;var n=Symbol.for("react.transitional.element"),a=Symbol.for("react.fragment");function i(l,s,d){var h=null;if(d!==void 0&&(h=""+d),s.key!==void 0&&(h=""+s.key),"key"in s){d={};for(var x in s)x!=="key"&&(d[x]=s[x])}else d=s;return s=d.ref,{$$typeof:n,type:l,key:h,ref:s!==void 0?s:null,props:d}}return vo.Fragment=a,vo.jsx=i,vo.jsxs=i,vo}var x1;function Ww(){return x1||(x1=1,cf.exports=Jw()),cf.exports}var c=Ww(),uf={exports:{}},we={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
