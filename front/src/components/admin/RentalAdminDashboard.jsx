...
const RentalAdminDashboard = () => {
  ...
  const fetchDashboardStats = async () => {
    try {
      const response = await fetch(
        'https://mocaapp.net/api/rental/admin/dashboard/stats'
      );
  ...
  const fetchMonthlyStats = async () => {
    try {
      const [monthlyRes, revenueRes] = await Promise.all([
        fetch(
          'https://mocaapp.net/api/rental/admin/stats/monthly-reservations'
        ),
        fetch('https://mocaapp.net/api/rental/admin/stats/revenue'),
      ]);
  ...
  const fetchVehicleStats = async () => {
    try {
      const response = await fetch(
        'https://mocaapp.net/api/rental/admin/stats/vehicle-types'
      );
  ...
  const fetchRegionStats = async () => {
    try {
      const response = await fetch(
        'https://mocaapp.net/api/rental/admin/stats/regions'
      );
